      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-convexo-navy mb-6">
              Why International Crypto Rails Matter
            </h2>
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              Traditional cross-border payment systems are slow, expensive, and opaque. Crypto rails offer a revolutionary alternative: instant settlement, transparent pricing, and 24/7 availability. For businesses in Latin America, this isn't just convenient—it's transformative.
            </p>
            <p className="text-lg text-gray-700 mb-8 leading-relaxed">
              With blockchain-based payment rails, LATAM enterprises can access international markets without the traditional barriers. No more waiting 3-5 days for wire transfers. No more losing 3-7% to intermediary fees. No more dealing with banking hour restrictions.
            </p>
            <Link
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-convexo-cream rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-convexo-navy mb-2">Instant Settlement</h3>
              <p className="text-gray-600">
                Transfer value globally in seconds, not days. No more waiting for bank clearances.
              </p>
            </div>
            ...
            <div className="bg-convexo-cream rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-convexo-navy mb-2">Lower Costs</h3>
              <p className="text-gray-600">
                Save up to 80% on international transfer fees compared to traditional banking.
              </p>
            </div>
            ...
            <div className="bg-convexo-cream rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-convexo-navy mb-2">Global Access</h3>
              <p className="text-gray-600">
                Reach any market, any time. True 24/7 financial operations without borders.
              </p>
            </div>
            ...
            <div className="bg-convexo-cream rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-convexo-navy mb-2">Full Transparency</h3>
              <p className="text-gray-600">
                Every transaction is traceable and verifiable on the blockchain. Complete audit trails.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 bg-gradient-to-r from-convexo-purple/5 to-convexo-blue/5 rounded-2xl p-8">
          ...
          <div className="text-center">
            ...
            <div className="text-gray-600">Lower Transaction Fees</div>
          </div>
          <div className="text-center">
          ...
          <div className="text-center">
            ...
            <div className="text-gray-600">Countries Accessible</div>
          </div>
        </div>
      </div>
    </section>
