      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
        <div className="animate-fade-in-up">
          ...
          <p className="text-xl md:text-2xl text-convexo-lightblue mb-12 max-w-3xl mx-auto">
            Access international funding through tokenized corporate bonds and institutional-grade digital asset services
          </p>
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="text-4xl font-bold text-convexo-cream mb-2">AI-Powered</div>
              <div className="text-convexo-lightblue">Credit Scoring</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-convexo-cream mb-2">NFT</div>
              <div className="text-convexo-lightblue">Evaluation Certificates</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-convexo-cream mb-2">Uniswap V4</div>
              <div className="text-convexo-lightblue">Integration</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-convexo-cream mb-2">Chainlink</div>
              <div className="text-convexo-lightblue">Oracles</div>
            </div>
          </div>
        </div>
      </div>
